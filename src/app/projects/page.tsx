                ...
                <div className="flex-1 p-4 space-y-6 overflow-y-auto">
                  ...
                  <div className="bg-white p-4 rounded-lg border border-gray-200">
                    ...
                    <div className="space-y-2">
                      ...
                      <button className="w-full flex items-center gap-2 p-2 bg-gray-50 hover:bg-gray-100 rounded-lg transition-colors text-left">
                    ...
                    <div className="bg-white p-6 rounded-lg border border-gray-200 shadow-sm">
                      ...
                      <div className="space-y-2 text-left">
                        <div className="p-3 bg-blue-50 hover:bg-blue-100 rounded-lg cursor-pointer transition-colors">
                          <span className="text-sm font-medium text-blue-900">Show me all my tasks</span>
                        </div>
                        <div className="p-3 bg-orange-50 hover:bg-orange-100 rounded-lg cursor-pointer transition-colors">
                          <span className="text-sm font-medium text-orange-900">What's overdue?</span>
                        </div>
                        <div className="p-3 bg-green-50 hover:bg-green-100 rounded-lg cursor-pointer transition-colors">
                          <span className="text-sm font-medium text-green-900">Display sprint as a kanban board</span>
                        </div>
                      </div>
                    </div>
                  </div>
